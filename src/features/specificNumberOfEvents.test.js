...
defineFeature(feature, (test) => {
  test("When user hasn't input a number for events, showing 2 events be default", ({
    given,
    when,
    then,
  }) => {
  ...
  test("When user inputs a specific number of events to see", ({
    given,
    when,
    then,
  }) => {
    let AppWrapper;
    given(
      'the user was typing "2" in the number of events text box',
      async () => {
